...
def main():
    ...
    # Creating widgets
    login_label = tkinter.Label(frame, text="Login", bg='#333333', fg="navy", font=("Arial", 30))
    ...
    login_button = tkinter.Button(frame, text="Login", bg="navy", fg="#FFFFFF", font=("Arial", 16), command=login)
